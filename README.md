...
Remember to consider your delays in transmission. My TX is part of my homebrew SDRUno based system and uses UDP datagrams to control the TX. I see delays from about 50 to 150ms on UDP TX commands. Also consider the SDR latency time. This effectively adds delays to the received signal (making it appear late) and on my SDRUno sytem I've measured this as 150 - 200ms so quite significant in FT2. So the UDP and SDR latency typically add ~ 200ms delay and this eats into the 500ms available.
